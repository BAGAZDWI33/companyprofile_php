    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">Innovative Technology Solutions in Web, IoT, and
                                Smart Computing for Modern Business Transformation</h1>
                            <p class="text-white pb-3 animated zoomIn"> To be the premier IT consulting partner in
                                the global industry with a focus on
                                innovation, reliability, and added value for
                                customers</p>
                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid" src="img/projek1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-5" id="home">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="section-title position-relative mb-4 pb-2">
                            ...
                            <h2 class="mt-2">The Best Information Technology Solution with 5 Years of Experience</h2>
                        </div>
                        <p class="mb-4">PT. Alfazza Solusi Indonesia merupakan Perusahaan
                            yang bergerak di bidang IT yang berdedikasi untuk
                            memberikan solusi teknologi informasi terbaik bagi
                            perusahaan-perusahaan di berbagai industri, swasta,
                            pemerintahan maupun UMKM.
                            Dengan pengalaman yang luas dan keahlian yang
                            mendalam dalam mengelola proyek-proyek kompleks,
                            kami bertekad untuk menjadi mitra strategis utama
                            dalam perjalanan transformasi digital klien kami</p>
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <h6 class="mb-3"><i class="fa fa-check text-primary me-2"> Inovasi</i></h6>
                                <h6 class="mb-0"><i class="fa fa-check text-primary me-2"> Keandalan</i></h6>
                            </div>
                            <div class="col-sm-6">
                                <h6 class="mb-3"><i class="fa fa-check text-primary me-2"> Efisiensi</i></h6>
                                <h6 class="mb-0"><i class="fa fa-check text-primary me-2"> Skalabilitas</i></h6>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="img/projek2.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                    <div class="service-icon flex-shrink-0">
                        <img src="img/gambar2.png" alt="SEO Icon" width="60">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                    <div class="service-icon flex-shrink-0">
                        <img src="img/gambar3.png" alt="SEO Icon" width="60">
                    </div>
                    <h5 class="mb-3">SERVER INSTALLATION</h5>
                    <p>Pengadaan Server,
                        Instalasi & Konfigurasi
                        Server, Sparepart Server
                    </p>
                    <a class="btn px-3 mt-auto mx-auto" href="">Read More</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                    <div class="service-icon flex-shrink-0">
                        <img src="img/gambar4.png" alt="SEO Icon" width="60">
                    </div>
                    <h5 class="mb-3">GRAPHIC DESIGN</h5>
                    <p> Branding & Identitas
                ...
                <div class="row align-items-center" style="height: 250px;">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="position-relative w-100 mt-3">
                            <!-- Tombol WhatsApp -->
                            <a href="https://wa.me/6285179975120?text=Halo,%20saya%20ingin%20berdiskusi%20mengenai%20solusi%20teknologi%20untuk%20perusahaan%20saya."
                                class="btn btn-light rounded-pill w-100 ps-4 pe-5 d-flex align-items-center justify-content-between"
                                style="height: 48px;">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            ...
                            <div class="px-4 py-3">
                                ...
                                <small>Directur Utama & IT Konsultan</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            ...
                            <div class="px-4 py-3">
                                ...
                                <small>Direktur & Professional Programmer</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="team-item">
                            ...
                            <div class="px-4 py-3">
                                ...
                                <small>Komisaris & Account Officer</small>
                            </div>
                        </div>
                    </div>
                </div>
